...
class TextureLoDTestApp : public VulkanApplication3DLight
{
	...
	void SetupObjects(VulkanSystem& system, RenderPass& renderPass, VkExtent2D workingExtent) override
	{
		...
		descriptor.AddTexture(system, 1, texture, VulkanPlayground::GetModelFile("Basics", "metalplate01_test.ktx"));
