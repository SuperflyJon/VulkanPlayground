...
class Textures3dSamplerArrayQuadsApp : public VulkanApplication3D
{
#include "..\..\models\quad.vertices"
	...
	void SetupObjects(VulkanSystem& system, RenderPass& renderPass, VkExtent2D workingExtent) override
	{
		...
		Shader &shader = pipeline.LoadShader(system, "SamplerArrayQuads");
...
DECLARE_APP(Textures3dSamplerArrayQuads)
