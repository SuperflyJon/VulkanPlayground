...
class DescriptorSetsCube2App : public VulkanApplication3D
{
	...
	void SetupObjects(VulkanSystem& system, RenderPass& renderPass, VkExtent2D workingExtent) override
	{
		...
		descriptor.AddTexture(system, 1, texture, VulkanPlayground::GetModelFile("Basics", "crate02_color_height_rgba.ktx"));
...
DECLARE_APP(DescriptorSetsCube2)
